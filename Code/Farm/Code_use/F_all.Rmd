...
Condition 1: BlockName=SQ01, BookletPart=1, BlockInPart=1.

Condition 2: BlockName=SQ01, BookletPart=2, BlockInPart=2.
...
eventname == "Nav:GoTo" or "UI:IsLoaded" & BlockName = "SQ01"
```{r}
result_time_complete_all=result_time_complete_all%>%
  filter(
